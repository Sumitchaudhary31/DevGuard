    ...
    <nav className="fixed w-full top-0 z-50 backdrop-blur-md bg-primary/80 border-b border-white/10">
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-8 items-center">
          ...
          <a
            href="#"
            className="px-6 py-2 rounded-full bg-gradient-to-r from-cyan-400 to-purple-600 text-white font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition"
          >
            Install Extension
          </a>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-secondary border-t border-white/10">
          <div className="flex flex-col gap-4 px-6 py-4">
            ...
            <a
              href="#"
              className="px-6 py-2 rounded-full bg-gradient-to-r from-cyan-400 to-purple-600 text-white font-semibold text-center"
            >
              Install Extension
            </a>
          </div>
