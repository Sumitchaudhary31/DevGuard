    ...
    <section className="min-h-screen flex items-center justify-center pt-20 px-6">
      <div className="text-center max-w-4xl">
        ...
        <div className="flex gap-4 justify-center flex-wrap mb-16">
          <a
            href="#"
            className="px-8 py-3 rounded-full bg-gradient-to-r from-cyan-400 to-purple-600 text-white font-semibold flex items-center gap-2 hover:shadow-lg hover:shadow-purple-500/50 transition transform hover:-translate-y-1"
          >
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-cyan-600/20 to-purple-600/20 blur-3xl rounded-3xl"></div>
